                ...
                <div className="container grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center text-white sm:justify-start">
                            <h1 className='text-white font-bold text-3xl mb-3 '>HeyDoc</h1>
                        ...
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            ...
                            <li>
                                <a
                                    ...
                                    className="text-white transition hover:text-teal-700/75"
                                >
                                    <span className="sr-only text-white">Dribbble</span>
                                    <svg
                                        className="h-6 w-6"
                                        fill="currentColor"
                                        viewBox="0 0 24 24"
                    ...
                    >
                        ...
                        <div className="text-center sm:text-left">
                            <p className="text-lg font-medium text-white" onClick={() => navigate("/contactUs")}>Contact Us</p>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-white hover:underline">john@doe.com</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-white hover:underline">0123456789</span>
                                    </a>
                                </li>
                                ...
                                >
                                    ...
                                    <address className="-mt-0.5 flex-1 not-italic text-white hover:underline">
