                    ...
                    <tbody>
                        {doctors.map((doc, key) => (
                            <tr key={key} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white mt-4">
                                    <img class="w-10 h-10 rounded-full" src={`http://127.0.0.1:8000${doc.doc_image}`} alt="Doctor image" />
                                    <div class="ps-3">
                                        <div class="text-base font-semibold">{doc.name}</div>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                {isActive ? <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to Unblock this Doctor?</h3> : <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to Block this Doctor?</h3>}
